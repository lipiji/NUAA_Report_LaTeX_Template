...
{   
    ...
    \author{
        ...
        \vspace{0.5cm}
        \kaishu\Large 学号\ \dlmu[9cm]{2025XXXXXX} \qquad  \\ %学号
        \vspace{0.5cm}
...
\subsection{插入图片}
NUAA校徽如\autoref{NUAA}所示，注意这里使用了\verb|~\autoref{}|命令，也就是会自动生成“图”“式”等前缀，无需手动输入。

\begin{figure}[!htbp]
    \centering
    \includegraphics[width =.7\textwidth]{figures/nuaa_logo_name.pdf}
    \caption{南京航空航天大学}
    \label{NUAA}
\end{figure}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width =.8\textwidth]{figures/nuaa_logo_name.pdf}
    \caption{南京航空航天大学}
    \label{NUAA}
\end{figure}
\end{verbatim}
